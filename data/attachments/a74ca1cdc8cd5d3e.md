...
- Name: tests/global_case_verification.spec.ts >> TC_15 Classic editable specs manual update feature validation
- Location: tests/global_case_verification.spec.ts:267:5
...
Call log:
  - waiting for getByRole('button', { name: 'Continue' }).or(locator('button:has-text("Continue")')).first() to be visible
